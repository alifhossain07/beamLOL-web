      ...
      <div className="w-9/12 mx-auto">
        ...
        >
          ...
          <div className="bg-gradient-to-b from-blue-600 to-blue-800 p-4 rounded-2xl shadow-lg min-w-[250px] text-center transform hover:scale-105 transition-transform duration-300">
            <img src="/assets/game1.webp" alt="Game Card" className="w-full h-60 object-cover rounded-lg mb-4" />
          ...
          <img src="/assets/game2.webp" alt="Game Card" className="w-full h-60 object-cover rounded-lg mb-4" />
            <FaGem className="text-5xl text-white mb-4 mx-auto" />
          ...
          <img src="/assets/game3.webp" alt="Game Card" className="w-full h-60 object-cover rounded-lg mb-4" />
            <FaGem className="text-5xl text-white mb-4 mx-auto" />
          ...
          <img src="/assets/game4.webp" alt="Game Card" className="w-full h-60 object-cover rounded-lg mb-4" />
          ...
          <img src="/assets/game5.webp" alt="Game Card" className="w-full h-60 object-cover rounded-lg mb-4" />
          ...
          <img src="/assets/game6.webp" alt="Game Card" className="w-full h-60 object-cover rounded-lg mb-4" />
            <FaGem className="text-5xl text-white mb-4 mx-auto" />
